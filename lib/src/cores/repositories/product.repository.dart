...
class ProductRepository {
  ...
  Future<Response> getData(String storeId, { Map<String, dynamic>? queryParams }) async {
    ...
    String url = "/product/store/$storeId";
    Response response = await getFetch(url, queryParameters: queryParams);
    return response;
  }

  Future<Response> search(String storeId, { Map<String, dynamic>? queryParams }) async {

    String url = "/product/store/$storeId/search";
    Response response = await getFetch(url, queryParameters: queryParams);
    return response;
  }
  ...
  Future<Response> copyProductFromStore(String id, Map<String, dynamic> data) async {

    showModalLoader();
    String url = "/product/copy/store/$id";
    Response response = await postFetch(url, data: data);
  ...
  Future<Response> uploadImage(String id, Object? data) async {
    ...
    String url = "/product/update-photo/$id";
